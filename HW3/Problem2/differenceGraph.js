...
//			.attr("d", line);
		...
		node1.append("rect")
			.attr("width", 2)
			.attr("height", function(d) {return (height - yScale(d.popul)) * 0.3;})
			.style("fill", function(d) {if (d.interp == false) {return "deepskyblue";} else {return "#999999";}})
			.style("opacity", 0.05)
			.attr("x", function(d) {return xScale(d.year) + buffer - 1;})
			.attr("y", function(d) {return yScale(d.popul) - (height - yScale(d.popul)) * 0.15;});					
		node1.append("rect")
			.attr("width", 2)
			.attr("height", function(d) {return (height - yScale(d.popul)) * 0.1;})
			.style("fill", function(d) {if (d.interp == false) {return "deepskyblue";} else {return "#999999";}})
			.style("opacity", 0.3)
			.attr("x", function(d) {return xScale(d.year) + buffer - 1;})
			.attr("y", function(d) {return yScale(d.popul) - (height - yScale(d.popul)) * 0.05;})				
			.append("svg:title")
			.text(function(d) {return d.year + ", " + d.popul});
